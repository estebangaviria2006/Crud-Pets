            ...
            {pet && (
                <div>
                    <div className='mt-11 relative'>
                        ...
                        <h3 className='ml-32 absolute top-3  text-gray-500'>{pet.name}</h3>
                    </div>

                    <div className='mt-3 relative'>
                        <img src={InfoRace} alt="Info Race" />
                        <h3 className='ml-32 absolute top-3  text-gray-500'>{pet.raza}</h3>
                    </div>

                    <div className='mt-3 relative'>
                        <img src={InfoCategory} alt="Info Category" />
                        <h3 className='ml-32 absolute top-3  text-gray-500'>{pet.categoria}</h3>
                    </div>

                    <div className='mt-3 relative'>
                        <img src={InfoGender} alt="Info Gender" />
                        <h3 className='ml-32 absolute top-3  text-gray-500'>{pet.genero}</h3>
                    </div>
                </div>
            )}
        </div>
